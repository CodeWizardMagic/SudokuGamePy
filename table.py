...
class Table:
    def __init__(self, screen, difficulty=1):
        ...
        self.puzzle = Sudoku(N_CELLS, (N_CELLS * difficulty) // 2)
        self.clock = Clock()
        ...
        self.reset_button = pygame.Rect(0, (HEIGHT + CELL_SIZE[1]), (CELL_SIZE[0]), (CELL_SIZE[1]))
        ...
        self.cur_sound = pygame.mixer.Sound("sounds/rightanswer-95219.mp3")
        self.wr_sound = pygame.mixer.Sound("sounds/error-call-to-attention-129258.mp3")
        self.win_sound = pygame.mixer.Sound("sounds/952782968e924cf.mp3")
        self.win_sound_played = False
        self.game_over_sound = pygame.mixer.Sound("sounds/0961f580f9e00da.mp3")
    ...
    def _draw_buttons(self):
        # adding reset button
        reset_button_color = pygame.Color("blue")
        pygame.draw.rect(self.screen, reset_button_color, self.reset_button)
        res_msg = self.font.render("Reset", True, self.font_color)
        self.screen.blit(res_msg,
                         (self.reset_button.x + (CELL_SIZE[0]) - 20, self.delete_button.y + (CELL_SIZE[1])))
    ...
    def handle_mouse_click(self, pos):
        ...
        if x <= WIDTH and y <= HEIGHT:
            ...
            if clicked_cell.value == 0:
                ...
                if self.making_move:
                    clicked_cell.color = pygame.Color(161, 210, 255)
                else:
                    clicked_cell.color = pygame.Color("white")
        ...
        # deleting numbers
            ...
            if self.cell_to_empty:
                ...
                self.cell_to_empty = None
                self.clicked_cell.color = pygame.Color("white")
